...
// Coach-editable parent email/phone. Saves each field independently on
// blur. The only way to fix a wrong or missing number for a player who
// signed up before phone capture existed - players can't edit this
// themselves, contact info is coach-managed.
export function ContactInfoEditor({
  ...
  const [savedField, setSavedField] = useState<"email" | "phone" | null>(null);
