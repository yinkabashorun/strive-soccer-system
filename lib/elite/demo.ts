...
export const DEMO_HOMEWORK: Homework[] = [
  ...hw("p-marcus", 5, [
    ...
    {
      title: "Towel-stop weight passes",
      exercise: "Pass so the ball dies ON the towel — weight over power",
      reps: "30 passes",
      duration_min: 10,
      session: 1,
      completed: true,
    ...
    {
      title: "Weak-foot towel-stop",
      exercise: "Left-foot passes that die on the towel",
      reps: "24 passes",
      duration_min: 10,
      session: 2,
      completed: true,
