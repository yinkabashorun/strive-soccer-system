...
export const DEMO_HOMEWORK: Homework[] = [
  ...hw("p-marcus", 5, [
    ...
    {
      title: "Two-touch wall passes",
      exercise: "Alternating feet, scan between every rep — weight over power",
      reps: "100 passes",
      duration_min: 10,
      session: 1,
      completed: true,
    ...
    {
      title: "Driven passes to a target",
      exercise: "Pick a spot on the wall, drive it flat and hard",
      reps: "40 passes",
      duration_min: 10,
      session: 1,
      completed: true,
    ...
    {
      title: "One-touch returns",
      exercise: "Off the wall, one touch back, stay on your toes",
      reps: "60 touches",
      duration_min: 10,
      session: 1,
      completed: true,
    ...
    { ...plyo(2), session: 2, completed: true, completed_at: daysFromNow(-10) },
    {
      ...
      exercise: "Left foot only — cushion and return in rhythm",
      reps: "80 passes",
      duration_min: 10,
      session: 2,
      completed: true,
    ...
    {
      title: "Pass through gates",
      exercise: "Two gates from shoes — split them from 10 yards",
      reps: "30 passes",
      duration_min: 10,
      session: 2,
      completed: true,
    ...
    },
    {
      ...
      exercise: "Lofted balls to a towel target, both feet",
      reps: "24 passes",
      duration_min: 10,
      session: 2,
      completed: true,
    ...
    { ...plyo(3), session: 3, completed: true, completed_at: daysFromNow(-9) },
    {
      ...
      exercise: "Shoulder check, then hit the wall — no check, no pass",
      reps: "50 reps",
      duration_min: 10,
      session: 3,
      completed: true,
    ...
    },
    {
      ...
      exercise: "Receive on the half-turn, pass through a gate",
      reps: "40 reps",
      duration_min: 10,
      session: 3,
      completed: true,
    ...
    {
      title: "First-touch pass combos",
      exercise: "Touch out of your feet, pass on the second",
      reps: "3 x 3 min",
      duration_min: 10,
      session: 3,
      completed: true,
    ...
    { ...plyo(4), session: 4, completed: true, completed_at: daysFromNow(-8) },
    {
      ...
      exercise: "Game speed — every pass off two touches max",
      reps: "3 rounds",
      duration_min: 10,
      session: 4,
      completed: true,
    ...
    },
    {
      ...
      exercise: "Watch a pro's passing angles, copy 3 patterns on the wall",
      reps: "1 clip + 30 reps",
      duration_min: 10,
      session: 4,
      completed: true,
  ...
  ...hw("p-marcus", 6, [
    ...
    {
      title: "First touch out of your feet",
      exercise: "Off the wall — first touch into space, not under you",
      reps: "60 touches",
      duration_min: 10,
      session: 1,
      completed: true,
    ...
    { ...plyo(2), session: 2, completed: true, completed_at: daysFromNow(-5) },
    {
      ...
      exercise: "Pop the ball up, kill it dead — foot, thigh",
      reps: "40 reps",
      duration_min: 10,
      session: 2,
      completed: true,
    ...
    },
    {
      ...
      exercise: "Two-touch, alternating feet, scan between reps",
      reps: "80 passes",
      duration_min: 10,
      session: 2,
      completed: true,
    ...
    { ...plyo(3), session: 3, completed: true, completed_at: daysFromNow(-4) },
    {
      ...
      exercise: "Left-foot control off the wall, settle in one",
      reps: "40 reps",
      duration_min: 10,
      session: 3,
      completed: true,
    ...
    {
      title: "Left-foot finishes",
      exercise: "Low and hard into a target — laces",
      reps: "25 strikes",
      duration_min: 10,
      session: 3,
      completed: true,
    ...
    { ...plyo(4), session: 4, completed: true, completed_at: daysFromNow(-3) },
    {
      ...
      exercise: "Open your hips before it arrives",
      reps: "40 reps",
      duration_min: 10,
      session: 4,
      completed: true,
    ...
    },
    {
      ...
      exercise: "A caller picks a gate late — touch through it",
      reps: "3 x 3 min",
      duration_min: 10,
      session: 4,
      completed: true,
    ...
    },
    {
      ...
      exercise: "Receive, scan, play forward — two touches max",
      reps: "20 reps",
      duration_min: 10,
      session: 4,
      completed: true,
