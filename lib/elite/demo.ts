...
export const DEMO_HOMEWORK: Homework[] = [
  ...hw("p-marcus", 5, [
    ...
    {
      title: "Foundations — inside-outside taps",
      exercise: "Inside-outside touches, both feet, eyes up the whole time",
      reps: "3 x 2 min",
      duration_min: 10,
      session: 1,
      completed: true,
    ...
    {
      title: "Sole rolls",
      exercise: "Roll it across your body, trap with the other foot",
      reps: "3 x 2 min",
      duration_min: 10,
      session: 1,
      completed: true,
    ...
    },
    {
      ...
      exercise: "Through two shoes, tight touches, both feet",
      reps: "3 x 2 min",
      duration_min: 10,
      session: 1,
      completed: true,
    ...
    { ...plyo(2), session: 2, completed: true, completed_at: daysFromNow(-10) },
    {
      ...
      exercise: "Left foot glued to the ball, quick rhythm",
      reps: "3 x 2 min",
      duration_min: 10,
      session: 2,
      completed: true,
    ...
    {
      title: "Weak-foot figure-8",
      exercise: "Left foot only — slow and perfect beats fast and sloppy",
      reps: "3 x 2 min",
      duration_min: 10,
      session: 2,
      completed: true,
    ...
    {
      title: "Weak-foot strikes at a target",
      exercise: "A bag or cushion — laces through, hold your follow-through",
      reps: "20 strikes",
      duration_min: 10,
      session: 2,
      completed: true,
    ...
    {
      title: "La croqueta reps",
      exercise: "Shift it across your body, burst a step past the cone",
      reps: "30 reps",
      duration_min: 10,
      session: 3,
      completed: true,
    ...
    {
      title: "Take-on reps",
      exercise: "Beat an imaginary defender — feint, touch, explode",
      reps: "20 reps",
      duration_min: 10,
      session: 3,
      completed: true,
    ...
    },
    {
      ...
      exercise: "Both feet, thighs allowed, beat your number",
      reps: "3 attempts",
      duration_min: 10,
      session: 3,
      completed: true,
    ...
    {
      title: "Quick-feet line drill",
      exercise: "20 seconds on, 40 off — over a sock line",
      reps: "5 rounds",
      duration_min: 10,
      session: 4,
      completed: true,
    ...
    },
    {
      ...
      exercise: "Still start, explode five yards, walk back",
      reps: "10 sprints",
      duration_min: 10,
      session: 4,
      completed: true,
    ...
    },
    {
      ...
      exercise: "Go on a clap or call from a parent — first step wins",
      reps: "8 sprints",
      duration_min: 10,
      session: 4,
      completed: true,
  ...
  ...hw("p-marcus", 6, [
    ...
    {
      title: "Self-toss first touch",
      exercise: "Throw it head height, kill it dead, touch into space",
      reps: "40 reps",
      duration_min: 10,
      session: 1,
      completed: true,
    ...
    {
      title: "Toe-taps and V-pulls",
      exercise: "Eyes up the whole time, quick rhythm",
      reps: "3 x 2 min",
      duration_min: 10,
      session: 1,
      completed: true,
    ...
    { ...plyo(2), session: 2, completed: true, completed_at: daysFromNow(-5) },
    {
      ...
      exercise: "Pop it up, kill it dead — foot, then thigh",
      reps: "40 reps",
      duration_min: 10,
      session: 2,
      completed: true,
    ...
    },
    {
      ...
      exercise: "First touch forward, explode three steps onto it",
      reps: "20 reps",
      duration_min: 10,
      session: 2,
      completed: true,
    ...
    {
      title: "Rolls and stops",
      exercise: "Sole roll, stop it dead, switch feet — control is king",
      reps: "3 x 2 min",
      duration_min: 10,
      session: 2,
      completed: true,
    ...
    {
      title: "Weak-foot self-toss control",
      exercise: "Left-foot first touch off your own toss, settle in one",
      reps: "40 reps",
      duration_min: 10,
      session: 3,
      completed: true,
    ...
    {
      title: "Weak-foot push-pulls",
      exercise: "Left foot only, keep it glued",
      reps: "3 x 2 min",
      duration_min: 10,
      session: 3,
      completed: true,
    ...
    {
      title: "Left-foot strikes at a target",
      exercise: "Driven strikes at a bag, net, or cushion — laces through",
      reps: "25 strikes",
      duration_min: 10,
      session: 3,
      completed: true,
    ...
    { ...plyo(4), session: 4, completed: true, completed_at: daysFromNow(-3) },
    {
      ...
      exercise: "Self-toss, open your hips before it lands",
      reps: "40 reps",
      duration_min: 10,
      session: 4,
      completed: true,
    ...
    },
    {
      ...
      exercise: "A caller picks a gate late — take your touch through it",
      reps: "3 x 3 min",
      duration_min: 10,
      session: 4,
      completed: true,
    ...
    },
    {
      ...
      exercise: "Self-toss, scan call, first touch into space and burst onto it",
      reps: "20 reps",
      duration_min: 10,
      session: 4,
      completed: true,
  ...
  ...hw("p-marcus", 7, [
    ...
    { ...plyo(1), session: 1, completed: true, completed_at: daysFromNow(-2) },
    {
      ...
      exercise: "Self-toss, shoulder check while it's up, first touch away from pressure",
      reps: "40 reps",
      duration_min: 10,
      session: 1,
      completed: true,
    ...
    {
      title: "Self-toss first touch",
      exercise: "Throw it up, first touch out of your feet into space",
      reps: "40 touches",
      duration_min: 10,
      session: 1,
      completed: true,
    ...
    },
    {
      ...
      exercise: "Left-foot sole rolls, taps, push-pulls — nonstop, eyes up",
      reps: "3 x 3 min",
      duration_min: 10,
      session: 3,
    },
    ...
    {
      title: "Study & apply",
      exercise: "Study Rodri's body shape before receiving, then copy it with self-toss receives.",
      reps: "1 clip + 30 reps",
      duration_min: 10,
      session: 4,
...
export const DEMO_WEEKLY_PLANS: WeeklyPlan[] = [
  {
    ...
    homework: [
      { title: "Scan and receive", exercise: "Shoulder check, then first touch away from pressure", reps: "40" },
